    ...
    for (size_t i = 0; i < max; ++i) {
        ...
        for (int t = 0; t < 2; ++t) {
            ...
            for (size_t n = 0; n < spks.size(); ++n) {
                ...
                BOOST_CHECK_EQUAL(IsSolvable(Merge(key_provider, script_provider), spks[n], false), (flags & UNSOLVABLE) == 0);
                ...
                BOOST_CHECK_EQUAL(IsSolvable(provider_inferred, spks_inferred[0], false), !(flags & UNSOLVABLE));
